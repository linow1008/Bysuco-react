                                ...
                                <ContentBox className="mt-[.625rem]">
                                    <Content className="border-r border-r-[#8ABAAB]">
                                        ...
                                        <div className="space-y-[.1875rem]">
                                            <div>
                                                <span>
                                                    상호 (주)청담글로벌 대표 최석주 전화 1800-0852 이메일
                                                    bysuco@outlook.kr
                                                </span>
                                            </div>
                                            <div>
                                                <span>
                                                    주소 인천 연수구 인천타워대로 323 B동 2401호 사업자등록번호
                                                    678-81-01062 [사업자정보확인]
                                                </span>
                                            </div>
                                            <div>
                                                <span>
                                                    통신판매업신고번호 제2018-3520125-30-2-00678 개인정보보호책임자
                                                    연원경
                                                </span>
                                            </div>
                                            <div>
                ...
                <Paper sx={{ position: "fixed", bottom: 0, left: 0, right: 0 }} className="h-[4.375rem]" elevation={3}>
                    <Box className="w-full">
                        ...
                        <BottomNavigationAction
                            label="홈"
                            icon={<HomeIcon sx={{ "& .Mui-selected": { color: "#006344" } }} />}
                            sx={{
                                color: "#C1C1C1",
                                fontSize: 10,
                        ...
                        <BottomNavigationAction
                            label="카테고리"
                            icon={<MenuIcon sx={{ "& .Mui-selected": { color: "#006344" } }} />}
                            sx={{
                                color: "#C1C1C1",
                                "&.Mui-selected": { color: "#006344" },
                                "&	.MuiBottomNavigationAction-label": { fontSize: ".5rem", mt: ".3125rem" },
                        ...
                        <BottomNavigationAction
                            label="마이페이지"
                            icon={<PersonOutlineOutlinedIcon sx={{ "& .Mui-selected": { color: "#006344" } }} />}
                            sx={{
                                color: "#C1C1C1",
                                "&.Mui-selected": { color: "#006344" },
                                "&	.MuiBottomNavigationAction-label": { fontSize: ".5rem", mt: ".3125rem" },
                        ...
                        <BottomNavigationAction
                            label="찜"
                            icon={<FavoriteBorderOutlinedIcon sx={{ "& .Mui-selected": { color: "#006344" } }} />}
                            sx={{
                                color: "#C1C1C1",
                                "&.Mui-selected": { color: "#006344" },
                                "&	.MuiBottomNavigationAction-label": { fontSize: ".5rem", mt: ".3125rem" },
                        ...
                        <BottomNavigationAction
                            label="최근 본 상품"
                            icon={<RestoreIcon sx={{ "& .Mui-selected": { color: "#006344" } }} />}
                            sx={{
                                color: "#C1C1C1",
                                "&.Mui-selected": { color: "#006344" },
                                "&	.MuiBottomNavigationAction-label": { fontSize: ".5rem", mt: ".3125rem" },
